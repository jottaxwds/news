...
const TopNewsScreen = lazy(() =>
  import("common/containers/TopNews/TopNewsScreen")
);
const SearchScreen = lazy(() =>
  import("common/containers/Search/SearchScreen")
);
const CategoriesScreen = lazy(() =>
  import("common/containers/Categories/CategoriesScreen")
);
const FullArticleScreen = lazy(() =>
  import("common/containers/FullArticleScreen/FullArticleScreen")
);
const FullCategoryScreen = lazy(() =>
  import("common/containers/FullCategory/FullCategoryScreen")
);
