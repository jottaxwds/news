...
const CountryMenu = () => {
  const { state: { country, countrySelectorDisabled },
  ...
  const lockByNavPath = location && location.pathname && BLOCKER_PATHS.includes(location.pathname); // eslint-disable-line no-restricted-globals
